<style>
  ...
  .team-container {
    max-width: 1400px;
    /* Section width capped at 1400px */
    width: 100%;
    display: flex;
    flex-direction: row;
    align-items: center;
...
<section class="team-section">
  <div class="team-container">
    <div class="team-logo">
      <img
        src="./assets/img/SultanSultan_Icon_Animated.gif"
        alt="main"
        class="main-image"
        loading="lazy"
    ...
    <div class="team-content">
      ...
      <a href="./phgvision.php" class="learn-more-btn">Learn More</a>
    </div>
  </div>
</section>