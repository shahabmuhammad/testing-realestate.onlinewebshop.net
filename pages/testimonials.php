      ...
      <div class="testimonials_container">
        ...
        <div class="testimonials_items">
          <div class="testimonials_item">
            <div class="testimonials_quote-icon"><img src="assets/img/airport.JPG" alt="Logo"></div>
          ...
          <div class="testimonials_item">
            <div class="testimonials_quote-icon"><img src="assets/img/corridore.JPG" alt="Logo"></div>
            <p class="testimonials_text">
          ...
          <div class="testimonials_item">
            <div class="testimonials_quote-icon"><img src="assets/img/loc.JPG" alt="Logo"></div>
            <p class="testimonials_text">
        ...
        <a href="./vision.php" class="testimonials_button">READ MORE</a>
      </div>
    </section>